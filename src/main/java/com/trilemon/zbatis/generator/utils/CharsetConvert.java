...
/**
 * 给定一个源文件路径或者File和目标路径 把源文件路径下的的所有txt文件和文件夹拷贝到目标路径下 并且可以按照给定的编码输出txt文件
 */
public class CharsetConvert {
    /**
     * 日志记录
     */
    private final static Logger logger = LoggerFactory.getLogger(CharsetConvert.class);
    ...
    public static void main(String[] args) {
        ...
        logger.info(String.valueOf(convert.convert()));
    }
