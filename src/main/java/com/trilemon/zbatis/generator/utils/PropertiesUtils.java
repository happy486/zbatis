...
public class PropertiesUtils {
    ...
    /**
     * 通过java.util.ResourceBundle获取属性, 从ClassPath中获取路径，不需要写 “.properties”后缀
     *
     * @param filename
    ...
    /**
     * java.util.Properties从java.io.InputStream(ClassLoader.getSystemResourceAsStream)中加载属性 从ClassPath中获取路径
     *
     * @param filename
     * @return java.util.Properties
     */
